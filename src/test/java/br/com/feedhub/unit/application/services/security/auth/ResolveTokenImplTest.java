...
class ResolveTokenImplTest {
    ...
    @Test
    @DisplayName("Test should return nulll when token provided is not valid")
    void testShouldReturnNull_whenTokenProvidedIsNotValid() {
        //When
        String resolvedToken = resolveToken.execute(token);
